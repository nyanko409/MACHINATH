...
public:
		...
		m_dissolveValue(1)
	{
		...
		// init dissolve values
		m_dissolveSpeed = 0.009;
		...
		else if (data.name == MESH_MAP_RED_CURVELEFT || data.name ==   MESH_MAP_RED_CURVERIGHT ||
		...
		else if (data.name == MESH_MAP_YELLOW_CURVELEFT || data.name ==   MESH_MAP_YELLOW_CURVERIGHT ||
		...
		else if (data.name == MESH_MAP_GREEN_CURVELEFT || data.name ==   MESH_MAP_GREEN_CURVERIGHT ||
		...
		else if (data.name == MESH_MAP_TWOTONE_CURVELEFT || data.name ==   MESH_MAP_TWOTONE_CURVERIGHT ||
		...
		else if(data.name == MESH_MAP_METROPOLITAN)
			m_dissolveColor = { 0,0,0 };

		else if (data.name == MESH_MAP_START)
		{
			m_dissolveColor = { 1,1,1 };
			m_dissolveSpeed = 0.003;
		}
	}
