...
//Cut@CÌNiexet@CÉÜßéj
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	//wèµ½NCAgÌæÉí¹Äé`ð²®
	AdjustWindowRect(&window_rect, window_style, FALSE);

	//EBhEÌé`ÀW©çÆ³ðvZ
	...
	//æÊÌÉEBhEð\¦·éæ¤ÀWvZ
	//½¾µæÊæèå«¢EBhEÍ¶ãÉí¹Ä\¦
...
LRESULT CALLBACK WndProc(HWND g_hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CLOSE:
		if (MessageBox(g_hWnd, "{ÉI¹µÄæëµ¢Å·©H", "mF", MB_OKCANCEL | MB_DEFBUTTON2) == IDOK) {
...
void DrawTitle()
{
	...
	//obNobt@[ÌNA FÍ230C0C255C255
